...
class _HabitDetailScreenState extends State<HabitDetailScreen> {
      ...
      builder: (context, provider, child) {
        ...
        if (widget.isPanel) {
          return Material(
            ...
            child: buildContent(currentHabit, context),
          );
        }

        // SAYFA MODU: Eski Scaffold yapın aynen devam
        return PopScope(
          canPop: false,
          ...
          child: Scaffold(
            primary: true, // Sayfa modunda true olmalı
            extendBody: true,
            ...
            body: buildContent(currentHabit, context),
          ),
        );
      },
    );
  ...
  Widget buildContent(Habit currentHabit, BuildContext context) {
